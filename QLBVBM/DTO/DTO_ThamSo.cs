...
namespace QLBVBM.DTO
{
    public class DTO_ThamSo
    {
        ...
        public DTO_ThamSo(int? soSanBayTGToiDa = null, int? tgBayToiThieu = null, int? tgDungToiThieu = null, int? tgDungToiDa = null, int? tgDatTruocVeToiThieu = null, int? tgHuyDatTruocVeToiThieu = null)
        {
